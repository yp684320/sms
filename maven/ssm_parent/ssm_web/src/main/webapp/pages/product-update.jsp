...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<script type="text/javascript">
		/*$("#productStatus") ：获取select选择框
			$("#productStatus option"): 获取选择框中的所有选项
			$("#productStatus option[value=1]"):获取选择框中的value=1的选项
			prop: 给页面中的某个标签设置属性（选择性的属性）
			attr: 给页面中的某个标签设置属性（非选择性的属性）
		* */
