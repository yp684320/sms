...
public class ProblemService {
        ...
        return new Specification<Problem>() {
            ...
            public Predicate toPredicate(Root<Problem> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
                ...
                if (searchMap.get("solve") != null && !"".equals(searchMap.get("solve"))) {
                    predicateList.add(cb.like(root.get("solve").as(String.class), "%" + (String) searchMap.get
                            ("solve") + "%"));
                }
                // 回复人昵称
    ...
    public Page<Problem> newlist(String label, Integer page, Integer size) {
        ...
        Page<Problem> pageData = problemDao.newlist(label, pageRequest);
    ...
    public Page<Problem> hotlist(String label, Integer page, Integer size) {
        ...
        Page<Problem> pageData = problemDao.hotlist(label, pageRequest);
    ...
    public Page<Problem> waitlist(String label, Integer page, Integer size) {
        ...
        Page<Problem> pageData = problemDao.waitlist(label, pageRequest);
